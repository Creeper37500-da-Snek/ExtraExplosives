...
namespace ExtraExplosives.UI.AnarchistCookbookUI
{
	internal class ButtonUI : UIState
	{
		...
		public override void Draw(SpriteBatch spriteBatch)
		{
			...
			{
				spriteBatch.Draw(Main.cdTexture, new Vector2(dragablePanel.Left.Pixels + 24, dragablePanel.Top.Pixels + 22), null, Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			}
		}
	}
